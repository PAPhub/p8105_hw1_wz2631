...
mean_logical <- mean(pull(hw1_df,var = 2))
  mean_logical
mean_character <- mean(pull(hw1_df,var = 3))
  mean_character
mean_factor <- mean(pull(hw1_df,var = 4))
  mean_factor
```
...
as.numeric(pull(hw1_df,var = 3))
as.numeric(pull(hw1_df,var = 4))
```
...
The warning doesn't occur when the factor variable is converted to numeric values. In the results, the values are equal to the levels of each element in this factor variable.
